...
from exam2_v2.library.views import index_view, add_book_view, edit_book_view, delete_book_view, book_details_view, profile_details_view, \
    edit_profile_view, delete_profile_view, create_profile_view
